...
const App = new Vue({
  ...
  data: {
    ...
    chatRoom: null,
    appId: '7aAFBjkD7qUlqtkw8Fl3yB3A-gzGzoHsz',
    appKey: 'MtvnhVOtBa4U1W5p887InUTj',
    server: 'https://7aafbjkd.lc-cn-n1-shared.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
    ...
    seekVideo() {
      ...
      this.controlParam.time = this.player.currentTime
      this.controlParam.list = this.videoList
      this.sendMessage(this.controlParam)
    },
  ...
  mounted() {
    ...
    /*使用socket-io*/
     //this.socket = io('http://192.168.101.34:2233'); // 替换成你的websocket服务地址
    ...
    var roomId = this.getParam("id")?this.getParam("id"):'622434d6b070cb7a32c57acd'
